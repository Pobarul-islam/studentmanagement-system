...
<body>
    ...
    <header class="main-header clearfix" role="header">
        ...
        <nav id="menu" class="main-nav" role="navigation">
            <ul class="main-menu">
                ...
                <li><a href="http://127.0.0.1:8000/students" class="external">Admin</a></li>
            </ul>
        </nav>
    </header>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p><i class="fa fa-copyright"></i> Copyright 2024 by Online School

                        | Design: <a href="https://github.com/Pobarul-islam" rel="sponsored" target="_parent">Pobarul
                            islam</a></p>
                </div>
            </div>
        </div>
